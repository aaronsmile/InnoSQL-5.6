...
{ "ER_RDSADMIN_DELETED", 1883, "users witch configured in user_list_string can not to be deleted or updated." },
{ "ER_USER_TABLE_DROPPED", 1884, "table mysql.user can not to be truncated or dropped." },
{ "ER_CPU_TIMES_LIMITED", 1885, "User \'%s@%s\' CPU resource is exhausted." },
{ "ER_IO_READS_LIMITED", 1886, "User \'%s@%s\' IO resource is exhausted." },
{ "ER_TRX_CPU_TIMES_LIMITED", 1887, "User \'%s@%s\' CPU times of the TRX limited." },
{ "ER_TRX_IO_READS_LIMITED", 1888, "User \'%s@%s\' IO reads of the TRX limited." },
{ "ER_PROFILER_ACCESS_DENIED", 1889, "Profile tables can\'t to be accessed by SQL." },
{ "ER_PROFILE_ALREADY_EXISTS", 1890, "Profile \'%s\' already exists." },
{ "ER_PROFILE_DOESNOT_EXIST", 1891, "Profile \'%s\' doesn\'t exist." },
{ "ER_ROLE_DOESNOT_EXIST", 1892, "Role \'%s\' doesn\'t exist." },
{ "ER_GRANT_ROLE_TO_USER", 1893, "grant role \'%s\' to user \'%s\'@\'%s\' WITH_CHECK_OPTION error, different \'%s\' privileges" },
